...
do_action( 'woocommerce_before_mini_cart' ); ?>
			...
			<?php 
				if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
					...
					<?php 
						...
						?>
						<span class="badge"><?php esc_html_e('0','coffee-station'); ?></span>
						<?php 
					}
				}
			?>
		</div>
		<h3><?php esc_html_e( 'Total:', 'coffee-station' ); ?> <?php echo esc_html( WC()->cart->get_cart_subtotal() ); ?></h3>
	</div>
				...
				<li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						...
						sprintf(
							...
							esc_attr__( 'Remove this item', 'coffee-station' ),
							esc_attr( $product_id ),
	...
	<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="theme-button"><?php esc_html_e('Checkout','coffee-station'); ?> </a>
...
<li class="shopping-cart">
		<div class="shopping-cart-header">
			...
			<h3><?php _e( 'Total:', 'coffee-station' ); ?> <?php echo WC()->cart->get_cart_subtotal(); ?></h3>
		</div>
		<ul class="woocommerce-mini-cart cart_list product_list_widget cart-items shopping-cart-items">
			<?php
			do_action( 'woocommerce_before_mini_cart_contents' );
