 ...
 */
function coffeestation_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function coffeestation_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function coffeestation_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function coffeestation_sanitize_float( $input ) {
 ...
 */
function coffeestation_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function coffeestation_sanitize_html( $html ) {
 ...
 */
function coffeestation_sanitize_image( $image, $setting ) {
 ...
 */
function coffeestation_sanitize_nohtml( $nohtml ) {
 ...
 */
function coffeestation_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function coffeestation_sanitize_range_value( $number, $setting ) {
 ...
 */
function coffeestation_sanitize_select( $input, $setting ) {
 ...
 */
function coffeestation_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function coffeestation_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function coffeestation_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
