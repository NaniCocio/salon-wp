...
add_action( 'customize_controls_enqueue_scripts', function() {
	...
	wp_enqueue_script(
		'coffeestation-customize-section-button',
	...
	wp_localize_script(
		'coffeestation-customize-section-button',
		'coffeestation_customizer_params',
		array( 
 ...
 */
function coffee_station_scripts() {
	...
	wp_enqueue_style('coffeestation-editor-style',get_template_directory_uri().'/assets/css/editor-style.css');

	wp_enqueue_style('coffeestation-main', get_template_directory_uri() . '/assets/css/main.css');

	wp_enqueue_style('coffeestation-woo', get_template_directory_uri() . '/assets/css/woo.css');
	
	wp_enqueue_style( 'coffeestation-style', get_stylesheet_uri() );
	...
	wp_enqueue_script('coffeestation-custom-js', get_template_directory_uri() . '/assets/js/theme.js', array('jquery'), false, true);

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'coffee_station_scripts' );
