...
<!-- Header Area -->
	...
	<?php 
		...
		$stickyheader = esc_attr(coffeestation_sticky_menu());
		$topheader_phonetext = esc_attr(get_theme_mod('topheader_phonetext','1-222-2333-33'));

	?>
<div class="main">
    <header class="main-header site-header <?php echo esc_attr(coffeestation_sticky_menu()); ?>">
				...
				<div class="headfer-content ">
					<div class="row m-rl">
						<div class="col-lg-4 col-md-5 col-sm-6  pd-0 logo-box">
							...
							<div class="box-info">
								<?php
									$coffeestation_site_desc = get_bloginfo( 'description');
									if ($coffeestation_site_desc) : ?>
										<p class="site-description"><?php echo esc_html($coffeestation_site_desc); ?></p>
								<?php endif; ?>
							</div>
						</div>
									...
									<div class="col-lg-10 col-md-12 col-sm-12">
										<div class="menu">
											...
											?>
												...
												<nav class="primary-menu-wrapper" aria-label="<?php echo esc_attr_x( 'Horizontal', 'menu', 'coffee-station' ); ?>">
													...
													if ( has_nav_menu( 'primary_menu' ) ) {
														...
														wp_list_pages(
															array(
																...
																'title_li' => false,
																'walker'   => new CoffeeStation_Walker_Page(),
															)
														);
