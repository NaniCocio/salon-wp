<?php
/**
 * Header file for the Coffee Station theme.
 *
...
<?php wp_body_open(); ?>
	...
	<div id="page" class="site">
		<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'coffee-station' ); ?></a>
	
	<?php 
		get_template_part('template-parts/sections/section','header'); 
		
		if ( !is_page_template( 'templates/template-frontpage.php' ) ) {
			coffeestation_breadcrumbs_style();  
		}
	?>
