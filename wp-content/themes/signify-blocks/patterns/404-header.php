<?php
 /**
  * Title: 404 Header
  * Slug: signify-blocks/404-header
			...
			<div class="wp-block-cover__inner-container">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group alignwide">
						...
						<h1 class="has-text-align-center"><?php esc_html_e ( '404 Nothing Found', 'signify-blocks' ); ?></h1>
						<!-- /wp:heading -->
						<!-- wp:paragraph {"textAlign":"center"} -->
						<p class="has-text-align-center"><?php esc_html_e ( 'Oops! That page can\'t be found', 'signify-blocks' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
				</div>
