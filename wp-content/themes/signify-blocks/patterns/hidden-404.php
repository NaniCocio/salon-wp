<?php
 /**
  * Title: Hidden 404
  * Slug: signify-blocks/hidden-404
...
<div class="wp-block-group wp-block-inner-page-title alignfull">
	...
	<div class="wp-block-group">
	  ...
	  <h2 class="has-text-align-center wp-block-post-title"><?php esc_html_e ( '404 Nothing Found', 'signify-blocks' ); ?></h2>
	  <!-- /wp:heading -->
	  <!-- wp:paragraph {"align":"center"} -->
	  <p class="has-text-align-center"><?php esc_html_e ( 'Oops! That page can\'t be found. Maybe try a search?', 'signify-blocks' ); ?></p>
	  <!-- /wp:paragraph -->
