<?php
  ...
  * Slug: signify-blocks/sidebar-products
...
<div class="wp-block-group wp-block-widget-area wp-block-sidebar">
	...
	<div class="wp-block-group wp-block-widget">
		...
		<h2 id="search-products" style="margin-top: 0px; margin-right: 0px; margin-bottom: 20px; margin-left: 0px;"><?php esc_html_e ( 'Search Products', 'signify-blocks' ); ?></h2>
		<!-- /wp:heading -->
	...
	<div class="wp-block-group wp-block-widget">
		<!-- wp:heading {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"20px","left":"0px"}}}} -->
		<h2 id="categories" style="margin-top: 0px; margin-right: 0px; margin-bottom: 20px; margin-left: 0px;"><?php esc_html_e ( 'Categories', 'signify-blocks' ); ?></h2>
		<!-- /wp:heading -->
	...
	<div class="wp-block-group wp-block-widget">
		...
		<div class="wp-block-woocommerce-filter-wrapper">
			<!-- wp:heading {"level":3} -->
			<h3><?php esc_html_e ( 'Filter by price', 'signify-blocks' ); ?></h3>
			<!-- /wp:heading -->
	...
	<div class="wp-block-group wp-block-widget wp-filter-by-size">
		...
		<div class="wp-block-woocommerce-filter-wrapper">
			<!-- wp:heading {"level":3} -->
			<h3><?php esc_html_e ( 'Filter by size', 'signify-blocks' ); ?></h3>
			<!-- /wp:heading -->
	...
	<div class="wp-block-group wp-block-widget wp-filter-by-color">
		...
		<div class="wp-block-woocommerce-filter-wrapper">
			<!-- wp:heading {"level":3} -->
			<h3><?php esc_html_e ( 'Filter by Color', 'signify-blocks' ); ?></h3>
			<!-- /wp:heading -->
